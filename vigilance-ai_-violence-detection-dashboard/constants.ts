...
export const MOCK_CAMERAS: Camera[] = [
  { id: 'cam01', city: 'TP. Hồ Chí Minh', district: 'Quận 1', ward: 'P. Bến Nghé', specificLocation: 'Phố đi bộ Nguyễn Huệ', status: CameraStatus.NORMAL },
  { id: 'cam02', city: 'TP. Hồ Chí Minh', district: 'Quận 1', ward: 'P. Bến Thành', specificLocation: 'Chợ Bến Thành', status: CameraStatus.VIOLENCE_DETECTED },
  { id: 'cam03', city: 'TP. Hồ Chí Minh', district: 'Quận 7', ward: 'P. Tân Phong', specificLocation: 'Cầu Ánh Sao', status: CameraStatus.NORMAL },
  { id: 'cam04', city: 'TP. Hồ Chí Minh', district: 'Quận Bình Thạnh', ward: 'P. 22', specificLocation: 'Landmark 81', status: CameraStatus.OFFLINE },
  { id: 'cam05', city: 'TP. Hồ Chí Minh', district: 'Quận 3', ward: 'P. Võ Thị Sáu', specificLocation: 'Dinh Độc Lập', status: CameraStatus.NORMAL },
  { id: 'cam06', city: 'TP. Hồ Chí Minh', district: 'TP. Thủ Đức', ward: 'P. Thảo Điền', specificLocation: 'Cầu Sài Gòn', status: CameraStatus.NORMAL },
  { id: 'cam07', city: 'TP. Hồ Chí Minh', district: 'Quận 1', ward: 'P. Phạm Ngũ Lão', specificLocation: 'Công viên 23/9', status: CameraStatus.NORMAL },
  { id: 'cam08', city: 'TP. Hồ Chí Minh', district: 'Quận 5', ward: 'P. 11', specificLocation: 'Chợ An Đông', status: CameraStatus.VIOLENCE_DETECTED },
  { id: 'cam09', city: 'TP. Hồ Chí Minh', district: 'Quận Tân Bình', ward: 'P. 2', specificLocation: 'Sân bay Tân Sơn Nhất', status: CameraStatus.NORMAL },
  { id: 'cam10', city: 'TP. Hồ Chí Minh', district: 'TP. Thủ Đức', ward: 'P. Hiệp Phú', specificLocation: 'Ngã tư Thủ Đức', status: CameraStatus.OFFLINE },
  { id: 'cam11', city: 'TP. Hồ Chí Minh', district: 'Quận 10', ward: 'P. 12', specificLocation: 'Vạn Hạnh Mall', status: CameraStatus.NORMAL },
  { id: 'cam12', city: 'TP. Hồ Chí Minh', district: 'Quận Gò Vấp', ward: 'P. 10', specificLocation: 'Ngã tư Phan Văn Trị', status: CameraStatus.NORMAL },
];
